...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('student_progress', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->unique(['user_id', 'track_id', 'module_id', 'lesson_id'], 'student_progress_unique_scope');
        });
        ...
        Schema::create('challenge_attempts', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->unique(['user_id', 'challenge_id', 'attempt_number'], 'challenge_attempts_unique_number');
        });
        ...
        Schema::create('notification_receivers', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->unique(['notification_id', 'user_id', 'channel'], 'notification_receivers_unique_channel');
        });
